...
`iotsploit_core.core` can be imported in standalone contexts. In a Django runtime, a real
backend should be injected during app startup (composition root).
"""
...
from iotsploit_core.domain.stream import StreamAction, StreamData, StreamSource, StreamType
from iotsploit_core.ports.stream_backend import StreamBackend
import logging
